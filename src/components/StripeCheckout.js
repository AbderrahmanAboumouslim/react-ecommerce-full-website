    ...
    <div>
      {success ? (
        ...
        <article>
          ...
          <p>Demo test card: 4242 4242 4242 4242</p>
        </article>
      )}
      <form id="payment-form" onSubmit={handleSubmit}>
        ...
        <p className={success ? "result-message" : "result-message hidden"}>
          Payment succeeded, see more information in your{" "}
  ...
  return (
    <>
      <Wrapper className="section">
        <div className="pay-method">USE PAYPAL</div>
        <PaypalForm />
        <br />
        <hr />
        <br />
        <div className="pay-method">USE STRIPE</div>
